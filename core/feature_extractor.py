...
arg_scopes_map = {
    ...
    'xception_65_skips': xception.xception_arg_scope,
...
networks_to_feature_maps = {
    ...
    'xception_65_skips': {
        DECODER_END_POINTS: {
            4: ['entry_flow/block1/unit_1/xception_module/'
                'separable_conv2_pointwise',
                'entry_flow/block2/unit_1/xception_module/'
                'separable_conv2_pointwise',
                'entry_flow/block3/unit_1/xception_module/'
                'separable_conv2_pointwise',
                'middle_flow/block1/unit_1/xception_module/'
                'separable_conv2_pointwise'],
        },
    },
...
_PREPROCESS_FN = {
    ...
    'xception_65_skips': _preprocess_zero_mean_unit_range,
